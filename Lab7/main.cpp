...
int main()
{
    ...
    int Choise = 0;
    while (Choise != 8) {
        std::cout << "What do you want to complete?" "\n"
        << "1. Sort numbers with a dot" "\n"
        << "2. Sorting numbers without a dot" "\n" 
        << "3. Character sorting" "\n" 
        << "4. Entering an array of people" "\n" 
        << "5. Sorting an array of people by age" "\n" 
        << "6. Sorting an array of people by name" "\n"
        << "7. Sorting an array of people by surname" "\n"
        << "8. Exit" "\n";
        std::cin >> Choise;
        if (Choise == 1) {
            vector <double> Doubles;
            std::cout << "Enter an array which ends by -1 ";
            while (true) {
                double temp;
                std::cin >> temp;
                if (temp == -1) break;
        ...
        if (Choise == 3) {
            vector <char> Chars;
            std::cout << "Entering an array ending by A ";
            while (true) {
                char temp;
        ...
        if (Choise == 4) {
            std::cout << "Enter an array format, people \"Name, surname, age\" ";
            while (a == 0)
            {
